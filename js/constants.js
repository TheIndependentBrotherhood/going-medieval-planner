...
const CALC_METHODS = [
  {
    id: "desire",
    label: "Envies",
    desc: "Priorités basées sur les envies du colon.",
  },
  {
    id: "expertise",
    label: "Expertise",
    desc: "Les meilleurs dans une compétence obtiennent les tâches associées.",
  },
  {
    id: "learning",
    label: "Apprentissage",
    desc: "Favorise les colons qui ont encore à apprendre.",
  },
  {
    id: "combined",
    label: "Combiné",
    desc: "Pondère les trois méthodes selon vos préférences.",
  },
];
...
const SKILL_ICONS = {
  ...
  "Dressage d'animaux":
    "https://cdn-icons-png.flaticon.com/128/18713/18713953.png",
...
const TASK_ICONS = {
  ...
  "Transport urgent":
    "https://cdn-icons-png.flaticon.com/128/18961/18961582.png",
...
const COMBAT_ROLES = [
  ...
  {
    id: "twoHanded",
    label: "Combattant 2 mains",
    skill: "Corps à corps",
    defaultPct: 30,
  },
  {
    id: "oneHanded",
    label: "Combattant 1 main",
    skill: "Corps à corps",
    defaultPct: 5,
  },
  {
    id: "oneHandedShield",
    label: "Combattant 1 main + bouclier",
    skill: "Corps à corps",
    defaultPct: 40,
  },
];
